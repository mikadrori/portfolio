...
export const sectionTitleClass =
  "font-['Permanent_Marker'] text-[28px] md:text-[30px] text-[#ff0090] tracking-[2px] pt-4 md:pt-8";
...
export const projectNameClass =
  "font-['Bricolage_Grotesque'] font-bold text-[28px] md:text-[24px] text-[#2200b8] tracking-[1.5px]";

export const subTitleClass =
  "font-['Bricolage_Grotesque'] font-semibold text-[22px] md:text-[19px] text-[#2200b8] tracking-[1.4px]";

export const smallTitleClass =
  "font-['Bricolage_Grotesque'] font-normal text-[18px] md:text-[17px] text-[#2200b8] tracking-[1px]";
