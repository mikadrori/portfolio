...
export function MuteButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-10 h-10 rounded-full text-white flex items-center justify-center transition-colors duration-200 cursor-pointer"
      style={{ backgroundColor: "rgba(13, 4, 57, 0.5)" }}
    >
      {muted ? (
