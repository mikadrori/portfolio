...
export const FINAL_ICON_SIZES = {
  ...
  munch:  "max-w-[60px] sm:max-w-[80px] md:max-w-[96px] lg:max-w-[109px]",
  bribe: FINAL_ICON_SIZE_DEFAULT,
  chabad:  "max-w-[60px] sm:max-w-[80px] md:max-w-[96px] lg:max-w-[117px]",
  weed: FINAL_ICON_SIZE_DEFAULT,
  robbery: FINAL_ICON_SIZE_DEFAULT,
  party: "max-w-[60px] sm:max-w-[80px] md:max-w-[96px] lg:max-w-[123px]",
} as const;
...
export const FINAL_DESIGN_ICON_COLUMNS: FinalDesignCol[] = [
  {
    layout: "single",
    src: "/assets/hostel_icon_u1zksb.svg",
    alt: "Hostel",
  ...
  },
  {
    layout: "stack",
    top: {
      src: "/assets/munch_icon_ukb2yp.svg",
      alt: "Munch",
      sizeClass: FINAL_ICON_SIZES.munch,
      offsetClass: "mt-[0.05rem]",
    },
    bottom: {
      src: "/assets/bribe_icon_rqtufa.svg",
      alt: "Police alert",
  ...
  {
    layout: "single",
    src: "/assets/chabad_icon_bjpydu.svg",
    alt: "Chabad House",
  ...
  },
  {
    layout: "stack",
    top: {
      src: "/assets/weed_icon_aazyi4.svg",
      alt: "Weed",
      sizeClass: FINAL_ICON_SIZES.weed,
    },
    bottom: {
      src: "/assets/robbery_icon_msuw87.svg",
      alt: "Robbery alert",
  ...
  {
    layout: "single",
    src: "/assets/party_icon_fukpld.svg",
    alt: "Party",
